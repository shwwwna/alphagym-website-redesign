# Alpha Gym — Implementation Instructions
...
- **Remove** the membership-comparison work proposed in the report (do not build the
  ...
  the home page as-is aside from the CTA fix in Part A.1 — the full detail lives on the new
...
1. Part A (all three fixes) — tiny, highest ROI.
2. Contact page + Pricing page routes.
3. Hero dual CTA (Part C) + day-pass section (Part B.2).
4. Sticky mobile CTA (Part B.1) + Instagram social block (Part B.4).
5. Trust badges / copy tightening (Part B.5, Part C urgency).
