...
const MEMBERSHIP_URL =
  "https://myaccount.clubfit.net.au/onlineoffers?code=ALPHAGYM&accountId=1&showall=true";
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            background: "linear-gradient(0deg, #0a0a0b, rgba(10,10,11,0))",
          }}
        />
        ...
        <div className="relative z-10 max-w-[1800px] mx-auto w-full">
          <div className="max-w-[680px] flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[color:var(--cream-64)] text-xs">
                No lock-in · cancel anytime
              </p>
            </div>
            <p className="text-[color:var(--cream-64)] text-sm">
              Join today, train tonight — staffed hours plus 24/7 swipe access,
              the gym floor is open around the clock.
            </p>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-[1800px] mx-auto flex flex-col gap-16">
          <div className="flex flex-col gap-6 max-w-[680px]">
            ...
            <p className="m-0 text-[color:var(--cream-64)] text-base leading-6">
              Classes for all ages and abilities, or one-on-one sessions at your
              own pace — whatever gets you to your goals.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-4">
            {COACHING.map((c) => (
              ...
              >
                <EditableImage
                  imageKey={c.imageKey}
                  className="h-52 bg-[color:var(--depth)]"
                />
                <div className="flex flex-col gap-3 p-8 grow">
                  <div className="text-[color:var(--cream)] text-xl font-medium">
                    {c.title}
                  </div>
                  <div className="text-[color:var(--cream-88)] text-base font-medium">
                    {c.hook}
                  </div>
                  <p className="m-0 text-[color:var(--cream-64)] text-base leading-6">
                    {c.body}
      ...
      <ValueFeaturesGrid
        ...
        actions={[
          { label: "Read more", href: "/recovery", primary: true },
          {
            ...
            href: "https://www.instagram.com/alpharecovery_woonona/?hl=en",
          },
        ]}
        imageSide="right"
        ...
        cards={[
          ...
          },
          {
            ...
            actions: [
              {
                label: "Go to website",
                href: "https://alphabarbershopwoonona.com/",
                primary: true,
              },
              {
                label: "Follow on Instagram",
                href: "https://www.instagram.com/alphabarbershopwoonona/",
              },
            ],
            imageSide: "right",
      ...
      <TwoColCta
        cards={[
          ...
          },
          {
            ...
            action: {
              label: "Ask About Elevate Access",
              href: "/contact",
              primary: true,
            },
          },
      ...
      >
        ...
        <div className="max-w-[1800px] mx-auto">
          <div className="flex flex-col items-center text-center gap-4 max-w-[540px] mx-auto mb-20">
            ...
            <h1 className="m-0 text-[color:var(--cream)] font-normal text-[64px] leading-[60px] tracking-[-2.5px]">
              Simple pricing.{" "}
              <span className="text-[color:var(--cream-64)]">No lock-in.</span>
            </h1>
          </div>
          <div className="grid md:grid-cols-3 gap-4">
            {[
              [
                ...
                "/week",
                false,
                "Full access to Alpha Recovery — ice bath, infrared sauna, Normatec and more.",
                null,
              ],
              [
                "24/7 Gym Access",
                ...
                "/week",
                true,
                "Unlimited 24/7 access to the full 650m² floor, functional zone and outdoor training.",
                null,
              ],
              [
                "Alpha Annual",
                ...
                "/year",
                false,
                "12 months of 24/7 access upfront — works out under $14.50/week.",
                "Save ~$339/yr vs. weekly",
              ],
              ...
              >
                <div className="flex justify-between items-center gap-2">
                  <div className="text-[color:var(--cream-88)] text-xl font-medium">
                    {title}
                  </div>
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex items-end gap-2">
                    <div className="text-[color:var(--cream)] text-[40px] leading-[40px] tracking-[-1px]">
                      {price}
                    </div>
                    <div className="text-[color:var(--cream-64)] text-sm">
                      {per}
                    </div>
                  </div>
                  <div className="text-[color:var(--cream-88)] text-base leading-6">
                    {desc}
                  </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-[color:var(--cream-64)] text-xs text-center m-0">
                    No lock-in · cancel anytime
                  </p>
                </div>
                <div className="flex flex-col gap-6">
                  <div className="font-mono-label text-[color:var(--cream-88)]">
                    Includes
                  </div>
                  <ul className="flex flex-col gap-4 m-0 p-0 list-none">
                    {["24/7 access", "No lock-in", "Member app"].map((f) => (
                      <li
                        key={f}
                        className="flex items-center gap-4 text-[color:var(--cream-88)] text-base"
                      >
                        <span className="flex-none w-6 h-6 rounded-lg bg-[color:var(--cream)] text-[#0a0a0b] flex items-center justify-center text-xs">
                          ✓
                        </span>
                        {f}
                      </li>
          ...
          <div className="flex flex-col items-center gap-2 mt-12 text-center">
            ...
            <Link
              to="/pricing"
              className="text-[color:var(--cream)] text-sm font-medium underline"
            >
        ...
        <div className="relative z-10 max-w-[1800px] mx-auto">
          <div className="flex flex-col items-center text-center gap-8 mb-20">
            ...
            <div className="flex flex-col items-center gap-4">
              <h2 className="m-0 text-[color:var(--cream)] font-normal text-5xl leading-[48px] tracking-[-2px]">
                What members{" "}
                <span className="text-[color:var(--cream-64)]">say</span>
              </h2>
              <p className="text-[color:var(--cream-64)] text-base">
                Real reviews from the Alpha Gym community.
              </p>
            </div>
          </div>
          <div className="max-w-[680px] mx-auto rounded-lg border border-[color:var(--cream-16)] bg-[color:var(--lift)] p-8 flex flex-col gap-8">
            <div className="flex flex-col gap-4">
              <span className="text-[color:var(--accent)] tracking-[0.2em]">
                ★★★★★
              </span>
              <p className="m-0 text-[color:var(--cream-88)] text-xl leading-7">
                "Best equipped gym in the Illawarra by far. 24/7 access, never
                overcrowded, and the recovery centre is a game changer."
              </p>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-sm font-medium text-[color:var(--cream-88)]">
                Alpha Gym Member
              </span>
              <span className="text-sm text-[color:var(--cream-64)]">
                Google Review
              </span>
            </div>
          </div>
      ...
      <section
        id="faq"
        className="relative py-24 px-8 border-y border-[color:var(--cream-16)] bg-[color:var(--lift)]"
      >
          ...
          <div className="flex flex-col gap-4">
            {[
              [
                ...
                "No. Our fortnightly memberships are no lock-in — cancel anytime with no exit fees.",
              ],
              [
                "Is there parking?",
                "Yes — secure underground parking with lift access straight to the gym floor.",
              ],
              [
                "What does it cost to join?",
                "24/7 gym access is $20.95/week with a one-off $49 joining fee and $0 access tag fee.",
              ],
              [
              ...
              <details
                key={q}
                className="rounded-lg bg-[color:var(--depth)] p-6 cursor-pointer"
              >
                <summary className="flex items-center justify-between gap-8 text-[color:var(--cream-88)] text-base font-medium list-none">
                  {q}
                  <span className="flex-none flex items-center justify-center w-8 h-8 rounded-lg bg-[color:var(--cream-08)] border border-[color:var(--cream-08)] text-[color:var(--accent)]">
                    +
                  </span>
                </summary>
                <p className="mt-4 text-[color:var(--cream-64)] text-base leading-6">
                  {a}
                </p>
              </details>
            ))}
      ...
      <TwoColCta
        cards={[
          ...
          },
          {
            ...
            description:
              "Fresh promos and events weekly — follow along on Instagram.",
            action: {
              label: "@alphagym.au on Instagram",
              href: INSTAGRAM_URL,
              primary: true,
            },
          },
